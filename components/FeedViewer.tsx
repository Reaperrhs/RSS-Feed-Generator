...
import { ArrowLeft, ExternalLink, Calendar, Code, List, Copy, Check, Download, Info, Cloud, Link as LinkIcon } from 'lucide-react';
      ...
      <div className="bg-card border border-slate-700 rounded-xl p-8 shadow-sm">
        <div className="mb-8 border-b border-slate-700 pb-6">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">{feed.parsedChannel.title}</h1>
